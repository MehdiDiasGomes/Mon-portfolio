        ...
        <div className='flex flex-col items-center justify-center'>
            <div className='flex flex-col gap-12 justify-center items-center'>
                <div className="flex flex-col gap-12 items-center">
                    <img src={Logo} alt="Logo du site" className="w-44 rounded-full" />
                    <h1 className='text-5xl text-white font-bold text-center'>Mehdi <br />
                        <span className='bg-gradient-to-r from-gradientPrimary to-gradientSecondary text-transparent bg-clip-text'> DIAS GOMES</span>
                    </h1>
                ...
                <div className='flex gap-7 text-primary'>
                    <a className='bg-primary text-black p-5 rounded-full flex justify-center items-center' href="#">Prenez contact</a>
                    <a className='text-primary border-2 border-primary p-5 rounded-full flex items-center justify-center hover:text-black hover:bg-primary duration-300' href="#">Ouvrir mon CV</a>
                </div>
            </div>
        </div>
    )
