        ...
        <div className='flex flex-col items-center justify-center'>
            <div className='flex flex-col gap-12 justify-center items-center'>
                <div className="flex flex-col gap-12 items-center">
                    ...
                    <h1 className='text-5xl sm:text-3xl text-white font-bold text-center'>Mehdi <br />
                ...
                <div className='flex gap-7 text-primary'>
                    <a className='bg-primary md:text-xl text-black p-5 flex justify-center items-center font-bold sm:text-paragMobile' href="#">Prenez contact</a>
                    <a className='text-primary md:text-xl border-2 border-primary p-5 flex items-center justify-center hover:text-black hover:bg-primary duration-300 font-bold sm:text-paragMobile' href="#">Ouvrir mon CV</a>
                </div>
            </div>
        </div>
    )
